...
import 'package:mobile_projek/pemilik/editprofilpemilik.dart';
import 'package:mobile_projek/users/landingPage.dart';

class ProfilPemilik extends StatefulWidget {
  @override
  State<ProfilPemilik> createState() => _ProfilPemilikState();
}

class _ProfilPemilikState extends State<ProfilPemilik> {
              ...
              TextButton(
                onPressed: () async {
                  ...
                  final response = await http.delete(
                    Uri.parse('http://10.0.2.2:8000/api/akun/$idPemilik'),
                    headers: {
