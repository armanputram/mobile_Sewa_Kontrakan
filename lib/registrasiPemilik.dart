...
class RegistrasiPemilik extends StatefulWidget {
  @override
  _RegistrasiPemilikState createState() => _RegistrasiPemilikState();
}

class _RegistrasiPemilikState extends State<RegistrasiPemilik> {
  ...
  Future<void> registerPemilik(BuildContext context, String email, String noHP,
    ...
    try {
      final response = await http.post(
        Uri.parse('http://10.0.2.2:8000/api/registrasipemilik'),
      ...
      if (response.statusCode == 200) {
        ...
        if (errorMessage.toLowerCase().contains('email')) {
          // Jika pesan kesalahan mengandung kata 'email', berarti email sudah terdaftar
          showDialog(
            context: context,
